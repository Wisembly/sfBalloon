...
abstract class BaseQuoteForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'poll_duration'  => new sfWidgetFormInputText(),
      'is_poll_active' => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'poll_duration'  => new sfValidatorInteger(array('required' => false)),
      'is_poll_active' => new sfValidatorBoolean(array('required' => false)),
