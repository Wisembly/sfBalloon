...
abstract class BaseWallFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'survey_actived'    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'survey_actived'    => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
